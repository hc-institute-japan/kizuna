...
export default (orchestrator, config) => {
  orchestrator.registerScenario("add a contact", async (s, t) => {
    ...
    // const add_contact_result_1 = await addContacts("alice")(conductor, "alice");
    const add_contact_result_2 = await addContacts("bobby")(conductor, "alice");
    ...
    // t.deepEqual(add_contact_result_1.agent_id, agent_pubkey_alice);
    // t.deepEqual(add_contact_result_1.username, "alice");
    t.deepEqual(add_contact_result_2.agent_id, agent_pubkey_bobby);
