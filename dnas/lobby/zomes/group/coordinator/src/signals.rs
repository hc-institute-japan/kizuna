use group_coordinator_types::{
    group::GroupOutput,
    group_message::{GroupMessageData, GroupMessageReadData, GroupTypingDetailData, PinDetail},
};
use hdk::prelude::*;
...
impl SignalName {
    ...
    pub const PIN_MESSAGE_DATA: &'static str = &"PIN_MESSAGE_DATA";
}
